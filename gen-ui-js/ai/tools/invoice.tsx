...
const LineItemSchema = z.object({
  id: z.string().default(uuidv4()).describe("Unique identifier for the line item"),
...
const PaymentInfoSchema = z.object({
  ...
  cardNumberLastFour: z.string().describe("Last four digits of the credit card number"),
});

export const InvoiceSchema = z.object({
  orderId: z.string().describe("The order ID"),
  lineItems: z.array(LineItemSchema).describe("List of line items in the invoice"),
  shippingAddress: ShippingAddressSchema.optional().describe(
    "Shipping address for the order"
  ),
  customerInfo: CustomerInfoSchema.optional().describe("Information about the customer"),
  paymentInfo: PaymentInfoSchema.optional().describe("Payment information for the order"),
});
